					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Parking Details</h4>
							...
							$id=$_GET['id'];
													...
													$sql="SELECT * FROM parking_tb where id=$id";
												...
												<div class="form-group">
													<label for="">Customer Name:          <?php echo $a;?></label>
													
													</div>
												</div>
													<div class="col-md-12">
													<div class="form-group">
													<label for="">Mobile Number:          <?php echo $b;?></label>
													
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Car Number:          <?php echo $c;?></label>
													
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Car Model:          <?php echo $d;?></label>
													
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Date:          <?php echo $e;?></label>
													
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Time:          <?php echo $f;?></label>
													
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Duration(H):          <?php echo $g;?></label>
													
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Parking Slot:          <?php echo $h;?></label>
