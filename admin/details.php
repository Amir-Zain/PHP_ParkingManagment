...
$sql="SELECT * FROM parking_tb where datex='".$_SESSION['datex']."'";
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Vehicle Details</h4>
										...
										<div class="form-body">
											<div class="row">
												...
												<div class="col-md-12">
													...
													<input type="text" id="" class="form-control" placeholder="Sex" name="sex" autocomplete="off" value="<?php echo $f;?>" readonly="yes">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Duration(H)</label>
													<input type="text" id="" class="form-control" placeholder="Sex" name="sex" autocomplete="off" value="<?php echo $g;?>" readonly="yes">
													</div>
												</div>
												<div class="col-md-12">
													<div class="form-group">
													<label for="">Parking Slot</label>
													<input type="text" id="" class="form-control" placeholder="Sex" name="sex" autocomplete="off" value="<?php echo $h;?>" readonly="yes">
													</div>
												</div>
