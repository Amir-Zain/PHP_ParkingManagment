	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Reciept</h2>
			</div>
											...
											<div class="row">
												<div class="col-sm-12" style="overflow-x: auto;">
													...
													<table id='datatables-example' class='table table-striped table-bordered dataTable no-footer' width='100%'' cellspacing='0' role='grid' aria-describedby='datatables-example_info' style='width: 100%;''>
														<thead>
															<tr role='row'>
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;''>Name Of Customer </th>
																...
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Start date: activate to sort column ascending' style='width: 119px;'>Car Number</th>
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Start date: activate to sort column ascending' style='width: 119px;'>Car Model</th>
																...
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Start date: activate to sort column ascending' style='width: 119px;'>Time</th>
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Age: activate to sort column ascending' style='width: 62px;'>Price(Rs)</th>
																<th class='sorting' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-label='Age: activate to sort column ascending' style='width: 62px;'>Parking Slot</th>
															</tr>
														</thead>";
														...
														<tbody>
															...
															<tr role='row' class='odd'>
																...
																<td>".$row['slot']."</td>
																<td>
																<a href=viewprint.php?id=".$row['id']."><span style='color:#fff;' class='btn btn-primary' title='Print Bill'>Print</span></a>
																</td>
																<td>
																<a href=delete.php?id=" . $row['id'] . "&slot=" . $row['slot'].">
																...
																<span style='color:#fff;' class='btn btn-danger glyphicon glyphicon-trash' title='Delete post'></span></a>
																</td>
