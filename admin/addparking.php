	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Parking</h2>
			</div>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Parking</h4>
										...
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													...
													<input type="text" id="" class="form-control" placeholder="Name Of Customer" name="name" autocomplete="off">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Phone Number</label>
													<input type="mail" id="" class="form-control" placeholder="Phone Number" name="mobile" autocomplete="off">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Car Number</label>
													<input type="text" id="" class="form-control" placeholder="Car Number" name="cnumber">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
													<label for="">Car Model</label>
													<input type="text" id="" class="form-control" placeholder="Car Model" name="model">
													</div>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													...
													<input type="text" id="timepicker" class="form-control timepicker" placeholder="Time" name="ptime" autocomplete="off">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="projectinput6">Parking Duration(H)</label>
														<select class="select2-B form-control" multiple="multiple" name="price">
													...
													$sql="SELECT * FROM slot_tb where status='0'";
													...
													<table id='datatables-example' class='table table-striped table-bordered dataTable no-footer' width='100%'' cellspacing='0' role='grid' aria-describedby='datatables-example_info' style='width: 100%;''>
														<thead>
															<tr role='row'>
																<th class='sorting_asc' tabindex='0' aria-controls='datatables-example' rowspan='1' colspan='1' aria-sort='ascending' aria-label='Name: activate to sort column descending' style='width: 169px;''>Slots Available</th>
														...
														<tbody>
															...
															<tr role='row' class='odd'>
																<td class='sorting_1'><input type='radio' value='$a' name='slot' > ".$row['addslots']."</td>
