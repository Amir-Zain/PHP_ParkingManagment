	...
	<div class="content-wrapper">
		<div class="content-header row">
			<div class="content-header-left col-md-6 col-xs-12 mb-1">
				<h2 class="content-header-title">Parking Slots</h2>
			</div>
					...
					<div class="col-xs-12">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title" id="basic-layout-form">Add Slots</h4>
										...
										<div class="form-body">
											<div class="row">
												<div class="col-md-6">
													...
													<label for="">Add Slots</label>
													<input type="text" id="" class="form-control" placeholder="Add Slots" name="addslots" autocomplete="off">
													</div>
												</div>
